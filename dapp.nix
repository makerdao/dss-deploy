# This file has been generated by dapp2nix 0.0.2, do not edit.
...
let
  ...
  specs = rec {
    ...
    dss-deploy_acae179 = rec {
      ...
      repo' = {
        name = "dss-deploy-acae179-source";
        url = "git@github.com:icetan/dss-deploy";
        rev = "acae179d2cd0e70fa9663622bedbfc904915f645";
        ref = "nix";
      };
      src' = fetchGit repo';
      src = "${src'}/src";
    };
    this = dss-deploy_acae179 // { src' = ./.; src = ./src; };
  };
in {
